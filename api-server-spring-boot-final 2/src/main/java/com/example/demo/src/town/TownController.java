...
public class TownController {
    ...
    public BaseResponse<List<GetTownListRes>> getTowns() throws BaseException {
    ...
    public BaseResponse<List<GetTownListRes>> getTown(@PathVariable("categoryId") int categoryId) throws BaseException {
    ...
    @ResponseBody
    @GetMapping("/{postId}")
    public BaseResponse<GetTownPostRes> getTownPost(@PathVariable int postId) throws BaseException {
        if (postId == 0){
    ...
    public BaseResponse<PostTownNewRes> createTown(HttpServletRequest request, @Valid @RequestBody PostTownNew postTownNew) throws BaseException {
    ...
    public BaseResponse<PostTownComRes> createTownCom(HttpServletRequest request, @PathVariable int postId, @Valid @RequestBody PostTownComReq postTownComReq) throws BaseException {
    ...
    public BaseResponse<String> createTownPostLiked(HttpServletRequest request, @PathVariable int postId) throws BaseException {
    ...
    public BaseResponse<String> createTownComLiked(HttpServletRequest request, @PathVariable int postId, @PathVariable int comId) throws BaseException {
    ...
    public BaseResponse<List<GetTownListRes>> getUserTownPosts(HttpServletRequest request) throws BaseException {
    ...
    public BaseResponse<List<GetTownComRes>> getUserTownComs(HttpServletRequest request) throws BaseException {
